...
kernel_params="$kernel_hardening tsc=reliable clocksource=tsc nowatchdog nmi_watchdog=0 split_lock_detect=off amdgpu.ppfeaturemask=0xffffffff module_blacklist=iTCO_wdt loglevel=3"
