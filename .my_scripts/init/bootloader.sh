...
kernel_params="$kernel_hardening pti=on preempt=full tsc=reliable clocksource=tsc libahci.ignore_sss=1 nowatchdog nmi_watchdog=0 module_blacklist=iTCO_wdt processor.ignore_ppc=1 split_lock_detect=off amdgpu.ppfeaturemask=0xffffffff"
