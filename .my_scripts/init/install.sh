...
# Packages
yay -S heroic-games-launcher-bin proton-ge-custom-bin ttf-ms-fonts cmst obs-gstreamer obs-vkcapture swaylock-effects-git --needed --noconfirm
sudo pacman -S adobe-source-sans-fonts ttf-jetbrains-mono adobe-source-serif-fonts cantarell-fonts otf-font-awesome pipewire pipewire-audio pipewire-pulse pipewire-alsa pipewire-jack wireplumber winetricks mangohud lib32-mangohud btop cabextract fuse cups curl dconf dbus-broker deluge deluge-gtk dnsmasq evolution evolution-ews firefox-developer-edition fish fisher gamemode gamescope glib2 gnome-keyring grim gvfs gvfs-mtp imv steam discord irqbalance alacritty lib32-gamemode lib32-libvdpau libappindicator-gtk2 libappindicator-gtk3 libsecret mako man-db micro mpv nemo nemo-fileroller nemo-preview npm obs-studio openvr p7zip pavucontrol pciutils polkit polkit-gnome profile-sync-daemon qt5-declarative qt5-wayland qt6-declarative qt6-wayland scrot seahorse slurp swappy sway swaybg tesseract-data-eng ufw unrar unzip code wayland-protocols wget wl-clipboard waybar wofi xdg-desktop-portal xdg-desktop-portal-wlr xorg-xwayland --needed --noconfirm
